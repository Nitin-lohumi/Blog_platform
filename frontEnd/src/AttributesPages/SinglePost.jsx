...
const SinglePost =({p,setPostIds,handleToggleDescription,submitLike
  ,expandedDescriptions,NavigateProfile})=>{

  const DeletePostByOwner=async(postId)=>{
       try {
         const res = await axios.delete(`http://localhost:3000/delete/postId/${postId}`);
     ...
     <div className="posts">
                  <div className="headerPost">
                    ...
                    <div className="TitleName">
                      ...
                      {NavigateProfile?<div className="PostsMenu">
                        <div className="flex items-center gap-2" onClick={()=>DeletePostByOwner(p._id)}> 
